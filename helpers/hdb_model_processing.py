...
filepath = "https://file.go.gov.sg/hdb-rfl-buyer-guide.pdf"
...
if os.path.exists("./vector_db_hdb"):
    import shutil
    shutil.rmtree("./vector_db_hdb")
...
vectordb = Chroma.from_documents(
    ...
    persist_directory="./vector_db_hdb"
)
...
def process_user_input_hdb(user_prompt):
